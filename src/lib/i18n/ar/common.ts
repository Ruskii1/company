...
export const common = {
  ...
  scheduled: "مجدول",
  waitingForProvider: "بانتظار مزود الخدمة",
  npa: "لم يتم القبول",
  npf: "لم يتم العثور",
  inRoute: "في الطريق",
  arrivedAtPickupLocation: "وصل إلى موقع الالتقاط",
  ...
  searchByOrderNumber: "بحث برقم الطلب",
  searchByInvoiceNumber: "بحث برقم الفاتورة",
  searchByCustomerName: "بحث باسم العميل",
  searchByProviderName: "بحث باسم المزود",
